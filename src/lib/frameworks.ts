...
export const FRAMEWORKS: FrameworkConfig[] = [
  {
    ...
    label: 'JSX',
    extension: '.tsx',
    title: 'SVG to React Component — Free Online Converter | SVG2Component',
  ...
  },
  {
    ...
    label: 'SFC',
    extension: '.vue',
    title: 'SVG to Vue 3 Component — Free Online Converter | SVG2Component',
  ...
  },
  {
    ...
    label: 'Svelte',
    extension: '.svelte',
    title: 'SVG to Svelte 5 Component — Free Online Converter | SVG2Component',
  ...
  },
  {
    ...
    label: 'RN',
    extension: '.tsx',
    title: 'SVG to React Native Component — Free Online Converter | SVG2Component',
    ...
    h1: 'SVG to React Native component.',
  ...
  },
  {
    ...
    label: 'TW',
    extension: '.tsx',
    title: 'SVG to Tailwind React Component — Free Online Converter | SVG2Component',
    ...
    h1: 'SVG to Tailwind React component.',
