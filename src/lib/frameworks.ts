...
export const FRAMEWORKS: FrameworkConfig[] = [
  {
    ...
    label: 'JSX',
    extension: '.tsx',
    title: 'SVG to React Component — Free Online Converter | SVG Wire',
    ...
    h1: 'Wire SVG assets into production-ready code.',
  ...
  },
  {
    ...
    label: 'SFC',
    extension: '.vue',
    title: 'SVG to Vue 3 Component — Free Online Converter | SVG Wire',
  ...
  },
  {
    ...
    label: 'Svelte',
    extension: '.svelte',
    title: 'SVG to Svelte 5 Component — Free Online Converter | SVG Wire',
  ...
  },
  {
    ...
    label: 'RN',
    extension: '.tsx',
    title: 'SVG to React Native Component — Free Online Converter | SVG Wire',
  ...
  },
  {
    ...
    label: 'TW',
    extension: '.tsx',
    title: 'SVG to Tailwind React Component — Free Online Converter | SVG Wire',
